"""
Misha: fix trigger bug in qcodes.instrument_drivers.yokogawa.Yokogawa_GS200.py
Program trigger is only avaliable with /MON option. 
Now program trigger paramenter is created only if /MON option is present
